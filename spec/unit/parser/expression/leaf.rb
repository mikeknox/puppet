...
describe Puppet::Parser::Expression::Leaf do
  before :each do
    @scope = stub 'scope'
    @value = stub 'value'
    @leaf = Puppet::Parser::Expression::Leaf.new(:scope => ((@scope)), :value => @value)
  end

  it "should have a evaluate_match method" do
    Puppet::Parser::Expression::Leaf.new(:scope => ((@scope)), :value => "value").should respond_to(:evaluate_match)
  end

  describe "when evaluate_match is called" do
    it "should evaluate itself" do
      @leaf.expects(:denotation)
    ...
    it "should match values by equality" do
      ...
      @leaf.stubs(:denotation).returns(@value)
...
describe Puppet::Parser::Expression::Undef do
  before :each do
    @scope = stub 'scope'
    @undef = Puppet::Parser::Expression::Undef.new(:scope => ((@scope)), :value => :undef)
  end
...
describe Puppet::Parser::Expression::HashOrArrayAccess do
  ...
  describe "when evaluating" do
    it "should evaluate the variable part if necessary" do
      ...
      access = Puppet::Parser::Expression::HashOrArrayAccess.new(:scope => ((@scope)), :variable => variable, :key => 0 )

      variable.expects(:denotation).returns("a")

      access.compute_denotation.should == "b"
    end
    ...
    it "should evaluate the access key part if necessary" do
      ...
      access = Puppet::Parser::Expression::HashOrArrayAccess.new(:scope => ((@scope)), :variable => "a", :key => index )

      index.expects(:denotation).returns(0)
    ...
    it "should be able to return an array member" do
      ...
      access = Puppet::Parser::Expression::HashOrArrayAccess.new(:scope => ((@scope)), :variable => "a", :key => 1 )

      access.compute_denotation.should == "val2"
    end

    it "should be able to return an hash value" do
      @scope.stubs(:lookupvar).with("a").returns({ "key1" => "val1", "key2" => "val2", "key3" => "val3" })

      access = Puppet::Parser::Expression::HashOrArrayAccess.new(:scope => ((@scope)), :variable => "a", :key => "key2" )
    ...
    it "should raise an error if the variable lookup didn't return an hash or an array" do
      ...
      lambda { access.compute_denotation }.should raise_error
    end
    ...
    it "should work with recursive hash access" do
      ...
      access1 = Puppet::Parser::Expression::HashOrArrayAccess.new(:scope => ((@scope)), :variable => "a", :key => "key")
      access2 = Puppet::Parser::Expression::HashOrArrayAccess.new(:scope => ((@scope)), :variable => access1, :key => "subkey")

      access2.compute_denotation.should == 'b'
    end
    ...
    it "should work with interleaved array and hash access" do
      ...
      access1 = Puppet::Parser::Expression::HashOrArrayAccess.new(:scope => ((@scope)), :variable => "a", :key => "key")
      access2 = Puppet::Parser::Expression::HashOrArrayAccess.new(:scope => ((@scope)), :variable => access1, :key => 1)
  ...
  describe "when assigning" do
    it "should add a new key and value" do
      ...
      access = Puppet::Parser::Expression::HashOrArrayAccess.new(:scope => ((@scope)), :variable => "a", :key => "b")
    ...
    it "should raise an error when trying to overwrite an hash value" do
      @scope.stubs(:lookupvar).with("a").returns({ "key" => [ "a" , "b" ]})
      access = Puppet::Parser::Expression::HashOrArrayAccess.new(:scope => ((@scope)), :variable => "a", :key => "key")
...
describe Puppet::Parser::Expression::Regex do
  ...
  describe "when initializing" do
    it "should create a Regexp with its content when value is not a Regexp" do
      ...
      Puppet::Parser::Expression::Regex.new :scope => ((@scope)), :value => "/ab/"
    end
    ...
    it "should not create a Regexp with its content when value is a Regexp" do
      ...
      Puppet::Parser::Expression::Regex.new :scope => ((@scope)), :value => value
    end
  end

  describe "when evaluating" do
    it "should return self" do
      val = Puppet::Parser::Expression::Regex.new :scope => ((@scope)), :value => "/ab/"

      val.compute_denotation.should === val
    end
  end
  ...
  describe "when evaluate_match" do
    before :each do
      ...
      @regex = Puppet::Parser::Expression::Regex.new :scope => ((@scope)), :value => "/ab/"
    end
  ...
  it "should delegate match to the underlying regexp match method" do
    regex = Regexp.new("/ab/")
    val = Puppet::Parser::Expression::Regex.new :scope => ((@scope)), :value => regex
...
describe Puppet::Parser::Expression::HostName do
  ...
  it "should not raise an error if hostname is a regex" do
    lambda { Puppet::Parser::Expression::HostName.new( :value => Puppet::Parser::Expression::Regex.new(:scope => ((@scope)), :value => "/test/") ) }.should_not raise_error
  end
  ...
  it "should stringify the value" do
    ...
    Puppet::Parser::Expression::HostName.new(:scope => ((@scope)), :value => value)
  end

  it "should downcase the value" do
    value = stub 'value', :=~ => false
    value.stubs(:to_s).returns("UPCASED")
    host = Puppet::Parser::Expression::HostName.new(:scope => ((@scope)), :value => value)

    host.value == "upcased"
  end

  it "should evaluate to its value" do
    @host.compute_denotation.should == @value
  end
